...
if ( $screen->id == 'widgets' ) {
	...
	$screen->add_help_tab( array(
		'id'      => 'corpobox-widgets',
		'title'   => __( 'Theme Features', 'corpobox' ),
		'content' =>  '<p><strong>' . __( 'Custom widgets', 'corpobox' ) . '</strong></p><p>' . __( 'The theme has custom widgets with the prefix Corpobox in the title. For the widget the Author box to fill in the biography in the edit screen of the user profile.', 'corpobox' ) . '</p>',
	) );
}
