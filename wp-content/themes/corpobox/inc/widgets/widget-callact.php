 ...
 * @package Corpobox
 */
add_action('widgets_init', create_function('', 'register_widget("Corpobox_Action_Widget");'));
...
class Corpobox_Action_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'corpobox_action_widget',
			'Corpobox ' . __( 'Call-To-Action', 'corpobox' ),
			array(
				'classname' => 'corpobox_action_widget', 
				'description' => __( 'Call to Action section', 'corpobox' ),
				'width' => 250,
				'height' => 350
			)
		);
 	...
 	function form( $instance ) {
 		$corpobox_defaults[ 'text_main' ] = '';
 		$corpobox_defaults[ 'button_text' ] = '';
 		$corpobox_defaults[ 'button_url' ] = '';
		$corpobox_defaults[ 'background' ] = 'transparent';
 		$instance = wp_parse_args( (array) $instance, $corpobox_defaults );
		...
		<p>
		<label for="<?php echo $this->get_field_id('text_main'); ?>"><?php _e( 'Main Text:','corpobox' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('button_text'); ?>"><?php _e( 'Button Text:', 'corpobox' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('button_url'); ?>"><?php _e( 'Button Link:', 'corpobox' ); ?></label>
	...
	<p>
	  <label for="<?php echo $this->get_field_id('background'); ?>"><?php _e( 'Background Color:', 'corpobox' ); ?></label> 
