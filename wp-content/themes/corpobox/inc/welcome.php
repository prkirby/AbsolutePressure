		...
		<div class="wrap">
			...
			<div class="about-description">
				...
				<?php endif; ?>
						...
						<h4><?php _e( 'Get Support', 'corpobox' ); ?></h4>

						<p><?php _e( 'For users of our premium themes our support is available 24/7. Just send us your questions.', 'corpobox' ); ?></p>
						<p><a href="<?php echo esc_url( 'http://dinevthemes.com/support/' ); ?>" class="button button-primary"><?php _e( 'Get Support', 'corpobox' ); ?></a></p>
