...
<?php $footer_bg = get_theme_mod( 'corpobox_footer_bg' ); ?>

<div class="out-wrap site-footer"<?php if( !empty($footer_bg) ) { ?>style="background: url(<?php echo esc_url( $footer_bg );?>) no-repeat 50%;background-size: cover;"<?php } ?>>
