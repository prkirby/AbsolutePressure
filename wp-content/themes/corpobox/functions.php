...
function corpobox_setup() {
	...
	register_nav_menus( array(
		...
		'footer' => __( 'Footer Menu', 'corpobox' ),
	) );
...
function corpobox_widgets_init() {
	...
	register_sidebar( array(
       ...
       register_sidebar(array(
            'name' => __('Home One Pre Before', 'corpobox'),
            'description' => __('The area Home One template pre before the contents in one line with no columns', 'corpobox'),
            'id' => 'home-one-prebefore',
            'before_title' => '',
            'after_title' => '',
       ...
       register_sidebar(array(
            'name' => __('Home One Before', 'corpobox'),
            'description' => __('The area Home One template before content in 2,3,4 column.', 'corpobox'),
            'id' => 'home-one-before',
       ...
       register_sidebar(array(
            'name' => __('Home One After', 'corpobox'),
            'description' => __('After the content in 2,3,4 column of Home One template', 'corpobox'),
            'id' => 'home-one-after',
            'before_title' => '<p class="widget-title">',
            'after_title' => '</p>',
            'before_widget' => '<div class="col">',
...
/**
 * Custom users profile fields
 */
require_once( get_template_directory() .'/inc/add-profile-fields.php' );
...
require_once ( get_template_directory() . '/inc/widgets/widget-imatext.php' );
...
require_once ( get_template_directory() . '/inc/widgets/widget-authorbox.php' );
 ...
 * Custom CSS
 */
if ( ! function_exists( 'corpobox_custom_css' ) ) {
	function corpobox_custom_css() {

	$options = get_option('corpobox_theme_settings');

	if ( !empty( $options['custom_style'] )  ) {
		echo '<!-- Options Custom Styles -->' . "\n";
		echo '<style type="text/css">' . "\n";
		echo $options['custom_style'] . "\n";
		echo '</style>' . "\n";
	}
//end
	}
	add_action( 'wp_head', 'corpobox_custom_css', 999 );
}
